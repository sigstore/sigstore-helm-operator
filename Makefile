...
# sigstore.dev/sigstore-helm-operator-bundle:$VERSION and sigstore.dev/sigstore-helm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= sigstore.dev/sigstore-helm-operator
